...
class ViewSpec : FreeSpec() {
    init {
        "on initialization" - {
            val userMap = PersistedMap<User>(Files.createTempDirectory("ss-"), User::class)
            ...
            "references should be correct" {
                viewByGender.references["MALE"]!!.names shouldEqual setOf("jack")
                viewByGender.references["FEMALE"]!!.names shouldEqual setOf("jill")
            }
        ...
        "on change of a view name after initialization" - {
            ...
            "references should be correct" {
                viewByGender.references["MALE"]!!.names should beEmpty()
                viewByGender.references["FEMALE"]!!.names shouldEqual setOf("jack", "jill")
        ...
        "should respond to an addition correctly" {
            ...
            viewByGender.references["MALE"]!!.names shouldEqual setOf("jack", "paul")
        ...
        "should respond to a deletion correctly" {
            ...
            userMap.remove("jill")
            viewByGender.references["FEMALE"]!!.names should beEmpty()
